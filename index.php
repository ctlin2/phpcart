...
$RecProduct = mysqli_query($con, $query_limit_RecProduct);
//以未加上限制顯示筆數的SQL敘述句查詢資料到 $all_RecProduct 中
$all_RecProduct = mysqli_query($con, $query_RecProduct);
//計算總筆數
...
$RecCategory = mysqli_query($con, $query_RecCategory);
//計算資料總筆數
$query_RecTotal = "SELECT count(`productid`)as totalNum FROM `product`";
$RecTotal = mysqli_query($con, $query_RecTotal);
